...
public class RegularExpressionTest {
	public static void main(String[] args) {
		...
		// 정규표현식
		String strPatt = "a[a-z]*"; //a라는 문자 하나로 시작해서 소문자a-z사이의 문자가 없거나 한 개 이상
		
		boolean r1 = Pattern.matches(strPatt, "apple"); // matches 커서 올려서 확인하기
		...
		String[] words = {"apple", "123abc", "123456", "011한글", "hello", 
							"홍길동", "1", "Banana", "APPLE", "#"};
		
		for(String word : words) { //배열 반복문
