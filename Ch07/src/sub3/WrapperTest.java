 ...
 * 날짜 : 2023/06/27
 * 이름 : 이황성
 * 내용 : Java Wrapper 클래스 (포장 클래스) 실습하기 (p524)
 * 
 * Wrapper 클래스
...
public class WrapperTest {
	public static void main(String[] args) {
		...
		System.out.print("box1 : " + box1);
		System.out.print(" box2 : " + box2);
		...
		int 	value1 = Integer.parseInt(str1); //중요
		...
		System.out.print("wr1 : " + wr1);
		System.out.print(" wr2 : " + wr2);
